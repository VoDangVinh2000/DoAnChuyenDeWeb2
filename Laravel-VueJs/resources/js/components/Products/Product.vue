    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <!-- Các Loại xe -->
                <div class="col-md-3">
                    <p> <a href="#" class="text-muted h5 box" @click.prevent="sedans">
                            <svg
                    ...
                    <p>
                        <a href="#"  class="text-muted h5 box" @click.prevent="xediahinh">
                           ...
                           <span> Xe địa hình / SUV</span> 
                         </a>
                    </p>
                    <p>
                         <a href="#"  class="text-muted h5 box" @click.prevent="xecoupe">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                            ...
                            ></path>
                            <path
                                d="M13.016 14.639c-3.034 0-5.517 2.483-5.517 5.517s2.483 5.517 5.517 5.517 5.517-2.483 5.517-5.517-2.482-5.517-5.517-5.517zm0 9.011c-1.931 0-3.494-1.563-3.494-3.494s1.563-3.494 3.494-3.494 3.494 1.563 3.494 3.494-1.563 3.494-3.494 3.494z"
                            ></path>
                            <path
...
methods :{
    sedans(){
        console.log("Chưa có xe sedans, ấn quài");
        const a = document.querySelector('.after');
        a.style.display = 'block';
     //   setTimeout(function(){   a.innerHTML = ""; }, 1500);
      
    },
    xediahinh(){
         console.log("Chưa có xe xe địa hình, ấn quài");
    },
    xecoupe(){
         console.log("Chưa có xe xe coupe, ấn quài");
    }
},
};
</script>
